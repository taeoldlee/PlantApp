...
export default function About() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section id="top" className="w-full px-4 py-16 text-center bg-green-50">
        <h2 className="text-5xl md:text-6xl font-bold text-green-800 mb-6">For Parents & Teachers</h2>
        <p className="text-2xl text-green-700 max-w-2xl mx-auto">
          Join us in nurturing a generation of young Earth stewards—one PlantPal at a time.
        </p>
      </section>

      {/* Mission Section */}
      <section className="w-full px-4 py-16 bg-green-50">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 shadow-lg transition-all duration-300 ease-in-out hover:scale-[1.02] hover:shadow-xl">
          <h3 className="text-4xl font-bold text-green-800 mb-8 text-center">Our Mission</h3>
          <div className="text-xl text-green-700 space-y-8">
            <p>
      ...
      <section className="w-full px-4 py-16 bg-white">
        <div className="max-w-4xl mx-auto bg-green-100 rounded-3xl p-8 shadow-lg transition-all duration-300 ease-in-out hover:scale-[1.02] hover:shadow-xl">
          <h3 className="text-4xl font-bold text-green-800 mb-8 text-center">Why It Matters</h3>
          <div className="text-xl text-green-700 space-y-8">
            <p className="text-2xl font-bold text-center">
              Plastic toys break. PlantPals build.
            </p>
            <p>
              We're designing experiences that help kids care for their environment, for living things, and for their own role in the future of our planet. We use eco-conscious materials, digital learning, and the power of storytelling to plant seeds of environmental awareness that will grow with every child.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Contact Section */}
      <section className="w-full px-4 py-16 bg-green-50 text-center">
